...
const initialExportData = { forecastData: [], insightData: [], isLoading: false, error: null };
const actionTypes = {
...
const useExportData = () => {
    ...
    const handleExportToExcel = () => {
        console.log('Exporting data:', state.forecastData, state.insightData);
        ...
        combinedData.forEach(sheet => {
            if (sheet.data && sheet.data.length > 0) {
                ...
                // Set custom headers and adjust column widths for Insight Data sheet
    ...
    return { state, setForecastData, setInsightData, setLoading, setError, handleExportToExcel };
};
